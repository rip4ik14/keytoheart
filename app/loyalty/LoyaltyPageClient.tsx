...
export default function LoyaltyPageClient() {
  ...
  /* ---------- side-effects ---------- */
  useEffect(() => {
    window.gtag?.('event', 'view_loyalty', {
  ...
  /* ---------- контент ---------- */
  const faqs: FAQ[] = [
    { question: 'Что такое кешбэк?', answer: 'Кешбэк – это возврат бонусных баллов на личный счёт. 1 балл = 1 ₽.' },
    { question: 'Как стать участником программы?', answer: 'Вы становитесь участником автоматически при первом заказе.' },
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 space-y-4">
          {/* вынужденно белый текст */}
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold uppercase text-white">
      ...
      >
        ...
        <div className="max-w-2xl mx-auto">
          <p className="text-gray-600 text-sm sm:text-base">
            Станьте участником программы автоматически при первом заказе. Покупайте на сайте, и мы
            начислим кешбэк на ваш счёт в течение 24 часов. Бонусами можно оплатить до 15 %
            следующего заказа!
          </p>
        </div>
      </motion.section>
        ...
        <div className="overflow-x-auto rounded-lg border border-gray-200">
          ...
          >
            <thead className="bg-gray-100">
              <tr>
                <th className="p-4 text-left font-medium text-gray-600 uppercase text-xs sm:text-sm">Название уровня</th>
                <th className="p-4 text-left font-medium text-gray-600 uppercase text-xs sm:text-sm">Процент</th>
                <th className="p-4 text-left font-medium text-gray-600 uppercase text-xs sm:text-sm">Сумма заказов</th>
              </tr>
            </thead>
            <tbody>
              {levels.map((lvl, idx) => (
