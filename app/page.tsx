...
export const metadata: Metadata = {
  title: 'KEY TO HEART – клубника в шоколаде с доставкой в Краснодаре',
  description:
    'Клубника в шоколаде, клубничные букеты и цветы с доставкой по Краснодару и до 20 км за 60 минут. Свежие ягоды, бельгийский шоколад, фото заказа перед отправкой.',
  keywords: [
    'клубника в шоколаде',
  ...
  openGraph: {
    title: 'KEY TO HEART – клубника в шоколаде, букеты и цветы',
    description:
      'Закажите клубнику в шоколаде, клубничные букеты и цветы с доставкой 60 мин по Краснодару и до 20 км.',
  ...
  twitter: {
    ...
    description:
      'Свежая клубника в шоколаде, букеты и цветы с доставкой за 60 мин по Краснодару и до 20 км.',
  ...
  return (
    <main aria-label="Главная страница">
      ...
      <h1 className="sr-only">
        KEY TO HEART – клубника в шоколаде, букеты и цветы с доставкой в Краснодаре
      </h1>
