    ...
    questions: [
      {
        ...
        a: 'KEY TO HEART — это сервис по созданию и доставке букетов и подарочных наборов из клубники в шоколаде и свежих цветов. Работаем по Краснодару и пригороду (Пашковский, Яблоновский, Энка и т.д.)',
      },
      {
