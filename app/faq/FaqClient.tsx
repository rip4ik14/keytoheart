...
const faqData = [
  {
    ...
    questions: [
      {
        q: 'Что такое KEY TO HEART?',
        a: 'KEY TO HEART — это сервис по созданию и доставке стильных букетов и подарочных наборов из клубники в шоколаде и свежих цветов. Работаем по Краснодару и пригородам (Пашковский, Яблоновский, Энка).',
      },
      {
    ...
    questions: [
      {
        ...
        a: [
          ...
          '',
          'Менеджер ответит в рабочее время 09:00–22:00. Заказы после 22:00 подтверждаются на следующий день утром.',
        ].join('\n'),
      },
      {
    ...
    questions: [
      {
        ...
        a: 'СБП, онлайн-ссылка CloudPayments (карты РФ и иностранных банков), наличные в мастерской, безнал по реквизитам для юрлиц.',
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: 'Как работает кешбэк от KEY TO HEART?',
