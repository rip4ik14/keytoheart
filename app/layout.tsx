            ...
            dangerouslySetInnerHTML={{
              __html: `
                (function() {
                  ...
                  // Keep analytics, but move heavy script execution away from initial TBT window.
                  if ('requestIdleCallback' in window) {
                    window.requestIdleCallback(loadMetrika, { timeout: 8000 });
                  } else {
                    setTimeout(loadMetrika, 6000);
                  }
                })();
              `,
            }}
