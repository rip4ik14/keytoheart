...
const occasionSeoText: Record<string, string> = {
  ...
  '23february': `Подарите мужчинам внимание и вкус на 23 февраля! Оригинальные сладкие наборы, клубника в шоколаде, брутальные букеты. Закажите доставку за 30 минут по Краснодару. <a href='/category/man' class='underline hover:text-black'>Подарки для мужчин</a>.`,
