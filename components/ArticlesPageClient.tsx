    ...
    <ClientAnimatedSection>
      <section className="max-w-3xl mx-auto space-y-8 text-gray-800">
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Клубничные букеты от KEY TO HEART – это не просто подарок, а настоящее произведение искусства, которое сочетает вкус, красоту и эмоции. Узнайте, почему они стали хитом в Краснодаре и как выбрать идеальный букет для любого события.
        </motion.p>
        ...
        >
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            Клубничные букеты – это современная альтернатива традиционным цветочным композициям. Вместо цветов в них используются свежие ягоды клубники, покрытые премиальным шоколадом, дополненные декоративными элементами, такими как цветы, зелень или сладости. Каждый букет создаётся вручную мастерами KEY TO HEART, что делает его уникальным.
          </p>
          <p className="text-base sm:text-lg leading-relaxed">
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            Выбор клубничного букета зависит от повода и предпочтений получателя. Вот несколько советов от KEY TO HEART:
          </p>
          ...
          <h2 className="text-2xl sm:text-3xl font-semibold" role="heading" aria-level={2}>
            Преимущества заказа в KEY TO HEART
          </h2>
          <p className="text-base sm:text-lg leading-relaxed">
            KEY TO HEART – это не просто интернет-магазин, а место, где создаются эмоции. Вот почему жители Краснодара выбирают нас:
          </p>
          <ul className="list-disc pl-5 space-y-2 text-base sm:text-lg" role="list">
            <motion.li
              role="listitem"
          ...
          <p className="text-base sm:text-lg leading-relaxed">
            Наши букеты – это способ подарить радость, которая запомнится надолго. Закажите клубничный букет в KEY TO HEART и удивите близких уже сегодня!
          </p>
            ...
            {[
              {
                ...
                answer: 'Клубничные букеты от KEY TO HEART сохраняют свежесть до 24 часов при правильном хранении в прохладном месте. Мы используем только свежие ягоды и рекомендуем дарить букет в день доставки.',
              },
              {
                question: 'Можно ли заказать доставку клубничного букета в Краснодаре?',
                answer: 'Да, KEY TO HEART предлагает быструю доставку клубничных букетов по Краснодару. Вы можете выбрать удобное время доставки при оформлении заказа.',
              },
              {
