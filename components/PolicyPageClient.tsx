  ...
  return (
    <section className="container mx-auto px-4 py-10 max-w-4xl text-base leading-relaxed text-black space-y-6">
      ...
      <motion.p
        ...
        viewport={{ once: true }}
      >
        Настоящая Политика конфиденциальности персональных данных (далее – Политика) разработана в соответствии с Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» и иными действующими законами РФ, действует в отношении всей информации, которую интернет-магазин КЛЮЧ К СЕРДЦУ, расположенный на доменном имени{' '}
        <Link
          href="/"
          className="underline hover:text-gray-500 transition-colors duration-300"
          aria-label="Перейти на главную страницу КЛЮЧ К СЕРДЦУ"
      ...
      <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        ...
        <ol className="list-decimal pl-5 space-y-1" role="list">
          ...
          <li><strong>Сайт КЛЮЧ К СЕРДЦУ</strong> – Совокупность веб-страниц под доменом keytoheart.ru и его субдоменами.</li>
          <li><strong>Пользователь</strong> – Лицо, использующее сайт КЛЮЧ К СЕРДЦУ через Интернет.</li>
        </ol>
      </motion.section>
