    ...
    <section className="container mx-auto px-4 py-10 max-w-4xl text-base leading-relaxed text-black space-y-6">
      ...
      <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        ...
        <ul className="list-disc pl-5 space-y-1" role="list">
          ...
          <li role="listitem">Видеозаписи доставки (для подтверждения вручения, включая биометрические данные, если лицо получателя видно);</li>
      ...
      <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        ...
        <ol className="list-decimal pl-5 space-y-1" role="list">
          <li role="listitem">
            Обработка осуществляется автоматизированными и/или иными способами. Данные удаляются после достижения цели обработки или по запросу Пользователя, если иное не предусмотрено законодательством.
          </li>
          <li role="listitem">
          ...
          <li role="listitem">
            Трансграничная передача данных не осуществляется. В случае необходимости такой передачи Администрация уведомит Роскомнадзор и обеспечит соблюдение требований 152-ФЗ.
          </li>
        </ol>
      </motion.section>
      ...
      <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        ...
        <p>
          Администрация несёт ответственность за нарушение условий Политики в соответствии с законодательством РФ. Все споры разрешаются путём переговоров, а при недостижении согласия – в суде в соответствии с законодательством РФ, включая право Пользователя подать иск по месту своего жительства (ст. 17 Закона РФ «О защите прав потребителей» № 2300-1).
        </p>
      </motion.section>
      ...
      <motion.section variants={sectionVariants} initial="hidden" whileInView="visible" viewport={{ once: true }}>
        ...
        <ol className="list-decimal pl-5 space-y-1" role="list">
          <li role="listitem">
            Администрация вправе вносить изменения в Политику, уведомляя Пользователя о существенных изменениях за 10 дней до их вступления в силу по email. Актуальная версия доступна на этой странице.
          </li>
          <li role="listitem">
