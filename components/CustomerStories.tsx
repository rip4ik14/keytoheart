...
export default function CustomerStories() {
  ...
  useEffect(() => {
    ...
    const hardcodedStories: CustomerStory[] = [
      {
        id: 1,
        review: 'Заказала букет из клубники в шоколаде для подруги на день рождения — она в восторге! Всё свежее, красиво упаковано, доставили вовремя. Спасибо, KEY TO HEART!',
        customer_name: 'Анна',
        date: '2025-05-01',
      },
      {
