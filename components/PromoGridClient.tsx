    ...
    >
      ...
      <div className="grid grid-cols-1 gap-4 sm:gap-6 lg:grid-cols-3">
        ...
        <motion.div
          ...
          style={{ minHeight: '300px' }} // для предотвращения скачка при первой загрузке
        >
          ...
          >
            {banners.map((b, i) => (
              <SwiperSlide key={b.id}>
                {/* aspect-ratio: 3/2 + minHeight: предотвращает скачки */}
                <div
                  className="relative aspect-[3/2] min-h-[250px] w-full"
                  style={{
                    background: '#f6f6f6',
          ...
          >
            {mobileItems.map((item, i) => (
              <SwiperSlide key={item.id}>
                <div
                  className="relative aspect-[3/2] min-h-[220px] w-full"
                  style={{ background: '#f6f6f6', borderRadius: 'inherit' }}
                >
                  <Link
                    href={item.href || '#'}
                    className="block h-full w-full"
                    ...
                    >
                      ...
                      {item.type === 'banner' && (
                        ...
                        >
                          <span
                            className="
                              inline-flex items-center border border-[#bdbdbdbd] rounded-lg px-3 sm:px-4 py-1.5 sm:py-2 font-bold text-xs sm:text-sm uppercase tracking-tight text-center 
                              bg-white text-[#535353] transition-all duration-200 shadow-sm
                              hover:bg-[#535353] hover:text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#bdbdbd]"
                            style={{
                              minWidth: 'fit-content',
        ...
        >
          {cards.slice(0, 4).map((c, i) => (
            <motion.div
              ...
              style={{ aspectRatio: '3/2', minHeight: 120 }}
            >
              <Link
                href={c.href}
