...
export default function PromoGridClient({
  ...
  // ✅ Важно для производительности: рендерим только активный и соседние слайды
  const visibleIndexes = useMemo(() => {
    if (!banners.length) return new Set<number>();
    ...
    >
        ...
        >
          <div className="relative h-full w-full">
            {banners.map((b, i) => {
              ...
              const isFirstLcp = i === 0; // первый баннер может быть LCP
              ...
              return (
                <div
                  ...
                  className={`
                    ...
                    transition-all duration-300 ${translate}
                  `}
                  ...
                  >
                    <div className="relative w-full h-full overflow-hidden rounded-[32px]">
                      <Image
                        ...
                        // ✅ Только первый слайд считаем LCP-кандидатом
                        priority={isFirstLcp}
      ...
      <div className="mt-4 sm:mt-6 mb-2 sm:mb-4 text-center">
        <p className="text-sm sm:text-base md:text-lg text-black/70 font-medium leading-snug">
          Клубника в бельгийском шоколаде и цветы с доставкой от 30 минут по
          Краснодару
        </p>
      </div>
    </section>
