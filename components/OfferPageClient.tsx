      ...
      <section className="max-w-4xl mx-auto space-y-8 text-gray-800">
        ...
        <div className="space-y-6">
          ...
          <ol className="list-decimal pl-5 space-y-2 text-base sm:text-lg leading-relaxed" role="list" aria-label="Общие положения">
            ...
            <li role="listitem">
              Администрация уведомляет Роскомнадзор об изменениях в обработке данных в течение 10 рабочих дней с момента таких изменений в соответствии с 152-ФЗ.
            </li>
            <li role="listitem">
          ...
          <ol className="list-decimal pl-5 space-y-2 text-base sm:text-lg leading-relaxed" role="list" aria-label="Согласие на рассылку">
            ...
            <li role="listitem">
              Администрация использует cookies для персонализации рассылки (например, подбора релевантных предложений). Пользователь может отключить cookies в настройках браузера, что не повлияет на возможность оформления заказа, но может ограничить персонализацию. Подробности в{' '}
              <TrackedLink
                href="/cookie-policy"
          ...
          >
            ...
            <ul className="list-disc pl-5 space-y-1" role="list">
              ...
              <li role="listitem">Передачи обезличенных данных по запросу Минцифры в целях статистики в соответствии с ФЗ № 233-ФЗ.</li>
            </ul>
            <p>
              Администрация применяет меры безопасности: шифрование, ограничение доступа, ежегодный аудит безопасности, хранение на защищённых серверах в Российской Федерации. Трансграничная передача данных не осуществляется.
            </p>
          </motion.div>
